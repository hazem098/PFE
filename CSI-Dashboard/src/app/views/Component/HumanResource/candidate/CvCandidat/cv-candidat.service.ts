...
export class CvCandidatService {
  ...
  private apiSkillCategory = 'http://localhost:8084/rh/skillsCategory';
  private apiSkill = 'http://localhost:8084/rh/skills';
  private apiCertification = 'http://localhost:8084/rh/certification';
  private apiAssOffreCandidat = 'http://localhost:8084/rh/AssOfferCandidate';
